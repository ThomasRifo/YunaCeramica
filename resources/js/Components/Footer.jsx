...
export default function Footer() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const v3Token = await window.grecaptcha.execute(
                "6LeWbjorAAAAAN1iTNC1iDlAzdGhuqJ9RKKVW0lN",
                { action: "newsletter_subscribe" },
            );

            // Validar el token con el backend
            const captchaResponse = await axios.post("/api/validar-captcha", {
                v3Token,
            });
        ...
        <footer loading="lazy" className="bg-black/85 text-white pt-16 pb-0">
            ...
            <div className="border-t bg-black border-gray-800  mt-0 py-5 text-center">
                <p className="md:inline">
                    &copy; {new Date().getFullYear()} Yuna Cerámica.
                </p>{" "}
