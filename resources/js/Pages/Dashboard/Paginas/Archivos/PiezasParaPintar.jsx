...
export default function PiezasParaPintar() {
  ...
  const handleSubmit = (e) => {
    ...
    formData.append('tipo', 'parapintar');
    archivos.forEach((file, i) => {
      formData.append('archivos[]', file);
    });
    router.post(route('dashboard.archivos.upload.parapintar'), formData, {
      forceFormData: true,
      onSuccess: () => {
  ...
  return (
    <Box sx={{ maxWidth: 600, mx: 'auto', mt: 6 }}>
      <Typography variant="h4" gutterBottom>Piezas Disponibles</Typography>
