                ...
                >
                    ...
                    >
                        ...
                        <FormControlLabel
                            control={
                                <Checkbox
                                    checked={data.tiene_atributos || false}
                                    onChange={(e) => {
                                        const checked = e.target.checked;
                                        setData((prevData) => ({
                                            ...prevData,
                                            tiene_atributos: checked,
                                            // Si desmarca el checkbox, limpiamos los atributos seleccionados y el tipo
                                            idTipoAtributo: checked
                                                ? prevData.idTipoAtributo
                                                : "",
                                            atributos: checked
                                                ? prevData.atributos
                                                : [],
                            ...
                            label="Contiene atributos"
                        />

                        {/* Renderizado condicional si el checkbox está seleccionado */}
                        {data.tiene_atributos && (
                            <>
                                {/* Selector de Tipo de Atributo */}
                                <FormControl
                                    fullWidth
                                    error={!!errors.idTipoAtributo}
                                    sx={{ mt: 0 }}
                                >
                                    <InputLabel id="select-tipo-atributo-label">
                                        Tipo de Atributo
                                    </InputLabel>
                                    <Select
                                        labelId="select-tipo-atributo-label"
                                        id="select-tipo-atributo"
                                        value={data.idTipoAtributo || ""}
                                        onChange={(e) => {
                                            const idTipo = e.target.value;
                                            // Si usás Inertia.js usa setData('key', val) o setData({ ...data, ... })
                                            // Si usás React State tradicional, unificá a tu handler habitual:
                                            setData({
                                                ...data,
                                                idTipoAtributo: idTipo,
                                                atributos: [], // Reseteamos los atributos seleccionados al cambiar de tipo
                                            });
                                        }}
                                ...
                                {/* Selector Múltiple de Atributos */}
                                {data.idTipoAtributo && (
                                    <Box sx={{ mt: 0 }}>
                                        <MenuSelector
                                            label="Atributos disponibles"
                                            /* 1. Prevenimos crash usando (atributosDisponibles || []) */
                                            menus={(
                                                atributosDisponibles || []
                                            ).filter(
                                                (attr) =>
                                                    attr.tipo_atributo_id ===
                                                    data.idTipoAtributo,
                                            )}
                                            /* 2. Prop corregida a minúscula: selectedMenus */
                                            selectedMenus={(
                                                atributosDisponibles || []
                                            ).filter((attr) =>
                                                (data.atributos || []).includes(
                                                    attr.id,
                                                ),
                                            )}
                                            onChange={(newAtributos) => {
                                                ...
                                                /* 3. Mantenemos coherencia con el setData */
                                                setData({
                                                    ...data,
                                                    atributos: atributoIds,
                                                });
                                                // O si usás Inertia helper corto: setData('atributos', atributoIds);
                                            }}
                                        />
                        ...
                        <TextField
                            ...
                            onChange={(e) =>
                                setData("dimensiones", e.target.value)
                            }
                    ...
                    <Box>
                        ...
                        <Typography
                            ...
                            sx={{ mb: 2 }}
                        >
                            Arrastra las imágenes para reordenarlas. La primera
                        ...
                        {imagenes.length === 0 ? (
                            ...
                            >
                                ...
                                <Typography variant="body1">
                                    No hay imágenes. Haz clic en "Agregar
                                    Imágenes" para comenzar.
                                </Typography>
                            </Box>
                        ) : (
                            <Box
