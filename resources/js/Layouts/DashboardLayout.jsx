...
const NAVIGATION = [
  ...
  { segment: "../dashboard/subcategorias", title: "Categorías", icon: <CategoryIcon/> },
  {
    ...
    children: [
      ...
      { segment: "../dashboard/clientes", title: "Clientes", icon: <GroupsIcon /> },
      { segment: "../dashboard/ventas", title: "Ventas", icon: <SellIcon /> },
    ],
  },
  { segment: "../dashboard/compras", title: "Compras", icon: <ShoppingCartIcon /> },
